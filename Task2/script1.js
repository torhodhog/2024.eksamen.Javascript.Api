...
// let ballsText = document.createElement("p");
// ballsText.textContent = 40;
// mainPlayerDiv.appendChild(betButton);
// mainPlayerDiv.appendChild(ballsText);
...
//     ballsText.textContent = playerBalls;
...
//       let hpText = player.querySelector(".ballsText");
...
//         Number(player.querySelector(".ballsText").textContent)
//       )
//     );
//     highestBettingPlayer = Array.from(allPlayers).find(
//       (player) => Number(player.querySelector(".ballsText").textContent) === highestBet
//     );
...
//       otherPlayers.forEach((player) => {
//         player.querySelector(".ballsText").textContent = "?";
//       });
//       currentBet = 0;
...
//       let highestBalls = Math.max(
//         ...Array.from(allPlayers, (player) =>
//           Number(player.querySelector(".ballsText").textContent)
//         )
//       );
//       let highestBettingPlayer = Array.from(allPlayers).find(
//         (player) => Number(player.querySelector(".ballsText").textContent) === highestBalls
//       );
...
//         highestBettingPlayer.querySelector(".hp").textContent
//       );
//       let winnerNewHP = winnerCurrentHP + totalBet - highestBet;
//       highestBettingPlayer.querySelector(".ballsText").textContent = winnerNewHP;
...
//           highestBettingPlayer.querySelector(".ballsText").textContent
//         }`
//       );
...
// // Når du oppretter hver spiller, legg til et element med klassen 'ballsText'
// let ballsText = document.createElement("p");
// ballsText.className = "ballsText";
// ballsText.textContent = pokemonData.name === mainPlayerName ? "40" : "?";
// pokemonDiv.appendChild(ballsText);

// pokemonDiv.dataset.ballsText = 40;
